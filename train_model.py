...
try:
    ...
    # Remove the extra quotes or spaces in column names
    ...
    # Features are all columns except the last one (which is 'quality')
    ...
    # Build pipelines & the assembler (preprocessing + model)
    ...
    # Choose the model the best model score
